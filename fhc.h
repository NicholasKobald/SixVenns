...
void create_distance_arr(Node G[FMAX], int [FMAX]);
void relabel_graph(Node GF[FMAX], Node G[FMAX], int [FMAX]);
int is_connected(Node GF[FMAX], int[FMAX], int curvert, int root);
